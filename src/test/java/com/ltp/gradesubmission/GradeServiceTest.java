...
public class GradeServiceTest {
    ...
    public void getGradesFromRepoTest() {
        when(gradeRepository.getGrades()).thenReturn(Arrays.asList(
            new Grade("Harry", "Potions", "3"),
            new Grade("Hermione", "Arithmancy", "4")
        ));
    ...
    public void gradeIndexTest() {
        Grade grade = new Grade("Harry", "Potions", "2");
    ...
    public void returnGradeByIdTest() {
        Grade grade = new Grade("Harry", "Potions", "1");
        when(gradeRepository.getGrades()).thenReturn(Arrays.asList(grade));
        when(gradeRepository.getGrade(0)).thenReturn(grade);
    ...
    public void addGradeTest() {
        ...
        Grade newGrade = new Grade("Hermione", "Arithmancy", "2");
